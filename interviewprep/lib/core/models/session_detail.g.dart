...
SessionDetailFeedback _$SessionDetailFeedbackFromJson(
...
Map<String, dynamic> _$SessionDetailFeedbackToJson(
  SessionDetailFeedback instance,
) => <String, dynamic>{
  'id': instance.id,
...
SessionConversation _$SessionConversationFromJson(Map<String, dynamic> json) =>
    SessionConversation(
      session: SessionResponse.fromJson(
        json['session'] as Map<String, dynamic>,
      ),
      feedback: json['feedback'] == null
          ? null
          : SessionDetailFeedback.fromJson(
...
Map<String, dynamic> _$SessionConversationToJson(
  SessionConversation instance,
) => <String, dynamic>{
