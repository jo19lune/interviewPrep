...
class ExerciceCreateRequest {
  ...
  factory ExerciceCreateRequest.fromJson(Map<String, dynamic> json) =>
      _$ExerciceCreateRequestFromJson(json);
...
class ExerciceResponse {
  ...
  factory ExerciceResponse.fromJson(Map<String, dynamic> json) =>
      _$ExerciceResponseFromJson(json);
